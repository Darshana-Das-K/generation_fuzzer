import random
import struct
def handle_enum(root, parent, enum_name, item_type,endian):
   # print("ENums are: ",enums)
   #Added this if elif block to find the enums in root or parent.
    if enum_name in root['enums']:
        enums= root['enums']
